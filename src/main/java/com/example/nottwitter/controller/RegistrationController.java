...
import com.example.nottwitter.domain.dto.CaptchaResponseDto;
...
public class RegistrationController {
            ...
            Model model)
    {
        ...
        boolean isConfirmEmpty = StringUtils.isNullOrEmpty(passwordConfirm);
    ...
    public String activate(Model model, @PathVariable String code, @Valid User user) {
